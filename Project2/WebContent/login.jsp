...
<!-- ---------------------- 본문 -------------------------------- -->
       		<div class="row d-flex justify-content-center">
       			<div class="col-md-5 ">
            		<form action="loginPro.jsp" method="post" class="p-2 contact-form">
	              		<div class="form-group">
	                		아이디(이메일): <input type="email" class="form-control" placeholder="이메일을 입력해주세요" name="id_email">
	              		</div>
	              		<div class="form-group">
	              		...
	              		<div class="form-group">
	             			<p class="d-flex justify-content-center mt-5 mb-0 d-block">
	                			...
	                			<input type="button" value="회원가입" class="btn btn-primary py-3 px-5 ml-3 " onclick="location.href='join.jsp';">
	              			</p>
	              		</div>
            		</form>
          		</div>
