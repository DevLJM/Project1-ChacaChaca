...
<!--          이용약관 body -->
     <div class="col-md-12 d-flex ftco-animate fadeInUp ftco-animated justify-content-center">
       	   <div class="col-md-7 "> 	
<form action="paymentinfo.html" class="bg-light p-5 contact-form" id="form1">
<div id="d1">
 <h2 align="center">이용약관 및 개인정보활용 동의</h2><br/><br/>
  <tr>
   <td align="left"><font size="2">전체 동의</font></td>
 
   <td><input type="checkbox" name="all" id="all"></td>
  </tr>
 <div id="accordion">
  
   <h3><strong>(필수) </strong>개인정보 방침 동의</font> <input type="checkbox" name="c1" id="c1"/></h3>
...
⑦"게시물"이라 함은 "회원"이 "서비스"를 이용함에 있어 "서비스상"에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다. 
   ...
   <h3><strong>(필수) </strong>서비스 이용약관 동의</font> <input type="checkbox" name="c2" id="c2"/></h3>
   <div>
...
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 네이버 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 네이버는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
   ...
   <h3><strong>(선택) </strong>마케팅 수신 동의</font> <input type="checkbox" name="c3" id="c3"/></h3>
   <div>
     <textarea readonly="readonly" rows="5" cols="66">
...
6. 이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도 등을 차단합니다.
  ...
  <tr>
   <td align="left">이벤트 등 프로모션 알림 메일 수신(선택)</font></td>
