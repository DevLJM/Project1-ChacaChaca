...
var imageSrc = '../images/carMarker2.jpg', // 마커이미지의 주소입니다    
...
var positions = [
    ...
    },
    {
        ...
        latlng: new kakao.maps.LatLng(35.09483611, 129.0263778)
    },
    {
    ...
    },
    {
        ...
        latlng: new kakao.maps.LatLng(35.14246667, 129.115375)
    },
    {
...
kakao.maps.event.addListener(marker, 'click', function() {
	...
	var site1 =  new kakao.maps.LatLng(35.187822158212, 129.21033701708),
		site2 = new kakao.maps.LatLng(35.107549481086, 129.03812574584),
		site3 = new kakao.maps.LatLng(35.09483611, 129.0263778),
		site4 = new kakao.maps.LatLng(35.13589444, 129.059175),
		site5 =new kakao.maps.LatLng(35.08811667, 129.0701861),
		site6 = new kakao.maps.LatLng(35.15995278,129.0553194),
		site7 = new kakao.maps.LatLng(35.20187222, 129.0858556),
		site8 =new kakao.maps.LatLng(35.13340833, 129.0865),
		site9 =  new kakao.maps.LatLng(35.19418056, 128.992475),
		site10 =   new kakao.maps.LatLng(35.16001944, 129.1658083),
		site11=new kakao.maps.LatLng(35.10142778, 128.9770417),
		site12=  new kakao.maps.LatLng(35.24007778, 129.0943194),
		site13= new kakao.maps.LatLng(35.20916389, 128.9829083),
		site14= new kakao.maps.LatLng(35.17318611, 129.082075),
		site15=  new kakao.maps.LatLng(35.14246667, 129.115375),
		site16 =  new kakao.maps.LatLng(35.14946667, 128.9933333);
		
	var markers = [{id: id, marker: marker}, {id: id, marker: marker}, ..] 
