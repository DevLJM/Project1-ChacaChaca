      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-8 block-9 mb-md-5">
            <form action="./ContactUpdatePro.cot?pageNum=${pageNum }" method="post" class="bg-light p-5 contact-form">
            <input type="hidden" name="bno" value="${dto.bno }"> <!-- 보이면 안되는 정보는 hidden으로 추가!!!!!!!!!!!!!!!!!!!!!! 필수정보는 꼭~~~~~!!!!! -->
              ...
              <div class="form-group">
                <input type="password" class="form-control" value="${dto.pass }" name="pass">
              </div>
              <div class="form-group">
