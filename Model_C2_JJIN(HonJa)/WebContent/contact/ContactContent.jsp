...
<!-- 			                <p><a href="blog-single.html" class="btn btn-primary">Continue <span class="icon-long-arrow-right"></span></a></p> -->
			              	<br>
			              	<input type="button" value="수정" onclick="location.href='./ContactUpdate.cot?bno=${dto.bno}&pageNum=${pageNum}';">
							<input type="button" value="삭제" onclick="location.href='./ContactDelete.cot?bno=${dto.bno}&pageNum=${pageNum}';">
							<!-- //<input type="button" value="답글"> -->
							<input type="button" value="목록" onclick="location.href='./ContactList.cot?pageNum=${pageNum}';">
